...
import json
email_config = dict()
with open(os.path.join(BASE_DIR, 'weather', 'email_config.json')) as json_file: # file will close automatically
...
SECRET_KEY = 'j=2#&=1#n0$@=s&9xk3em#hoeet2f)y0+lhvi=%uwy-nkj0s14'
